            ...
            <div className="grid md:grid-cols-2 gap-16 items-center">
              <motion.div {...fadeInUp} className="order-2 md:order-1">
                <div className="relative rounded-2xl overflow-hidden shadow-2xl aspect-[4/5]">
                  <img 
                    src="https://images.unsplash.com/photo-1680789524940-305e942db2f1?q=80&w=1974&auto=format&fit=crop" 
              ...
              <motion.div {...fadeInUp} className="order-1 md:order-2 space-y-6">
                ...
                <p className="text-foreground/70 text-lg font-light leading-relaxed">
                  Apple Jucy isn't just a name; it's an experience curated for those who appreciate the finer things. We believe that wellness and luxury should seamlessly intertwine.
                </p>
                <p className="text-foreground/70 text-lg font-light leading-relaxed">
                  Our membership portal is designed to provide you with unparalleled access to our most coveted recipes, behind-the-scenes insights, and a community of like-minded individuals who share your dedication to quality.
                </p>
                <div className="pt-4">
          ...
          <div className="container mx-auto max-w-6xl">
            ...
            <div className="grid md:grid-cols-3 gap-8 items-center">
              {tiers.map((tier, index) => (
                ...
                >
                  <Card className={`relative h-full flex flex-col transition-all duration-500 rounded-2xl border-border/50 ${
                    tier.featured 
